...
function createSingletonState({ factory, initialState }) {
  ...
  return function useSingletonState() {
    const [state, setState] = (0, import_react2.useState)(value);
...
function useCurrentMode(elementRef) {
  const [value, setValue] = (0, import_react3.useState)("light");
...
function useDensityMode(elementRef) {
  const [value, setValue] = (0, import_react3.useState)("comfortable");
  useMutationObserver(elementRef, (node) => {
...
function useReducedMotion(elementRef) {
  const [value, setValue] = (0, import_react3.useState)(false);
  useMutationObserver(elementRef, (node) => {
...
function detectVisualRefreshFlag() {
  ...
  return (_b = (_a = global2 === null || global2 === void 0 ? void 0 : global2[awsuiVisualRefreshFlag]) === null || _a === void 0 ? void 0 : _a.call(global2)) !== null && _b !== void 0 ? _b : false;
}
...
function useComponentMetadata(componentName, packageVersion, analyticsMetadata) {
...
var framework = "react";
function buildMetricDetail({ source, action, version, configuration }, theme2) {
...
function buildMetricName({ source, version }, theme2) {
  return ["awsui", source, `${formatVersionForMetricName(theme2, version)}`].join("_");
}
...
function formatVersionForMetricName(theme2, version) {
  return `${theme2.charAt(0)}${getMajorVersion(version).replace(".", "")}`;
}
...
// node_modules/@cloudscape-design/component-toolkit/internal/base-component/component-metrics.js
function useComponentMetrics(componentName, { packageSource, packageVersion, theme: theme2 }, configuration = { props: {} }) {
...
var PACKAGE_VERSION = "3.0.0 (0e8e875d)";
...
var getVisualTheme = (theme2, isVR) => {
  if (theme2 === "polaris" && isVR) {
    return "vr";
  }
  return theme2;
};
...
function useTelemetry(componentName, config) {
  ...
  const theme2 = getVisualTheme(THEME, isVisualRefresh);
...
var InternalI18nContext = import_react9.default.createContext({
  locale: null,
  format: (_namespace, _component, _key, provided) => provided
});
function useLocale() {
  return (0, import_react9.useContext)(InternalI18nContext).locale;
}
function useInternalI18n(componentName) {
  const { format } = (0, import_react9.useContext)(InternalI18nContext);
...
//# sourceMappingURL=chunk-RYJI6LXR.js.map
